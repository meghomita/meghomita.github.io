...
![an image alt text]({{ site.baseurl }}/images/tattoo1.png)
<span style="font-size:16px;"> My first tattoo as a dedication to my grandmother. </span>
![an image alt text]({{ site.baseurl }}/images/tattoo2.png)
...
![an image alt text]({{ site.baseurl }}/images/tattoo3.png)
...
![an image alt text]({{ site.baseurl }}/images/tattoo5.jpg)
